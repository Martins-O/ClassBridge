        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-primary-100 to-secondary-100 rounded-2xl p-12 text-center">
              ...
              <div className="text-xl text-gray-700 mb-8">Schools Trust ClassBridge</div>
              <div className="text-6xl font-bold text-secondary-600 mb-4">50K+</div>
              <div className="text-xl text-gray-700">Active Students</div>
            </div>
          </div>
        </div>
      </section>
