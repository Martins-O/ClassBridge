...
import ClassBridgeLogo from './ClassBridgeLogo';
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <ClassBridgeLogo size="md" className="text-white" />
            <p className="text-gray-300 text-sm leading-relaxed">
              Bridging the gap between mentors and students through innovative educational management.
            </p>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6 text-sm text-gray-300">
              <span>© 2024 ClassBridge. All rights reserved.</span>
